...
export default function ProductosGenerator({handleLogout,username}) {
    ...
    return (
      <div className='flex justifyContent-center flex-direction-column align-center containerRandom gap'>
        ...
        <Button className='botonAleatorio' onClick={handleLogout} variant="contained">Desconectarte</Button>
